...
Route::get('/health', 'Api\HealthCheckController@ping');
Route::get('/health/status', 'Api\HealthCheckController@status');
Route::get('/health/dian', 'Api\HealthCheckController@dianStatus');
