    ...
    <table style="font-size: 9px">
        <tr>
            ...
            <td class="vertical-align-top" style="width: 35%; padding-left: 1rem">
                <table>
                    <tr>
                        <td style="padding: 0; width: 50%;">Modo Transporte:</td>
                        <td style="padding: 0;">{{$request['transportation_information']['transport_mode']}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 0; width: 50%;">Medio de Transporte:</td>
                        <td style="padding: 0;">{{$request['transportation_information']['transport_mean']}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 0; width: 50%;">Numero de Placa:</td>
                        <td style="padding: 0;">{{$request['transportation_information']['plate_number']}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 0; width: 50%;">Origen:</td>
                        <td style="padding: 0;">{{$request['transportation_information']['origin_place']}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 0; width: 50%;">Destino:</td>
                        <td style="padding: 0;">{{$request['transportation_information']['destination_place']}}</td>
                    </tr>
                    <br>
                    <tr>
